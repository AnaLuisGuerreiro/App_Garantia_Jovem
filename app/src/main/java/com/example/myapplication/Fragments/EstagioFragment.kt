...
import com.example.myapplication.databinding.FragmentEstagioBinding
import com.example.myapplication.databinding.FragmentSelectedInfoBinding

class EstagioFragment : Fragment() {

    private lateinit var binding: FragmentEstagioBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEstagioBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupClickableText(view: View) {
        ...
        val textView = view.findViewById<TextView>(R.id.information4)
        val text = "As candidaturas deverão ser efetuadas pelas entidades promotoras acima referidas.\n\nSe a entidade empregadora com quem falares quiser saber mais, clica aqui."

        val spannableString = SpannableString(text)
        val clickableSpan = object : ClickableSpan() {
            override fun onClick(widget: View) {
                val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.iefp.pt/estagios?tab=estagios-ativar-pt"))
